...
export default class SignUp extends Component {
    ...
    Register = async () => {
        axios
            .get("http://localhost:8090/Login/doRegister", {
                params: {
                ...
                <div className='flex flex-col items-start gap-8 lg:flex-row'>
                    ...
                    <div className='flex-1 w-full mb-8 bg-white border border-gray-300 rounded-lg px-6 py-8'>
                        <div className='flex justify-center gap-x-4 mb-8'>
                            <div>
                                <div className='font-bold text-[36px] text-center'>Create Account</div>
                                <Link to='' className='text-violet-700 text-sm'>
                                    Please choose your user type correctly !
                                </Link>
                            </div>
                        </div>
                        <form className='flex flex-col gap-y-4'>
                            <div className='flex justify-center gap-x-2'>
                                <input
                                    ...
                                    name='usertype' value='0' type='radio' checked
